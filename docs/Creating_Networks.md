...
Cytoscape Web can also import network files in **[CX2 JSON format](https://cytoscape.org/cx/cx2/specification/cytoscape-exchange-format-specification-(version-2)/)** (.cx2), wich is also the format used to store them in NDEx.

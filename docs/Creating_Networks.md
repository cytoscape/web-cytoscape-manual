...
*HINT: CX2 JSON files can be generated by the **Cytoscape desktop application** for any networks using **File → Export → Network to File...**. For more details, please review section [23.1. Raw Data Export](https://manual.cytoscape.org/en/stable/Export_Your_Data.html#network) of the Cytoscape manual.*
